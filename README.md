...
dependencies {
    ...
    implementation fg.deobf("com.teamresourceful.resourcefullib:resourcefullib-forge-1.21.4:3.4.0")
}
```
...
dependencies {
    <--- Other dependencies here --->
    implementation "com.teamresourceful.resourcefullib:resourcefullib-fabric-1.21.4:3.4.0"
}
```
...
dependencies {
    <--- Other dependencies here --->
    modImplementation "com.teamresourceful.resourcefullib:resourcefullib-common-1.21.4:3.4.0"
}
```
...
dependencies {
    <--- Other dependencies here --->
    modImplementation "com.teamresourceful.resourcefullib:resourcefullib-fabric-1.21.4:3.4.0"
}
```
...
dependencies {
    <--- Other dependencies here --->
    modImplementation "com.teamresourceful.resourcefullib:resourcefullib-forge-1.21.4:3.4.0"
}
```